...
local List = {
	{ -- Cow
		...
		["Distance"] = 50,
		["Coords"] = vec4(3066.1,5564.48,197.46,192.76),
		["Model"] = "ig_abigail",
		["Collision"] = true
	},{ -- Cow
	["Distance"] = 50,
	["Coords"] = vec4(464.35,-1995.07,3.96,308.98),
	["Model"] = "ig_abigail",
	["Collision"] = true
	},{ -- Cow
		["Distance"] = 50,
	...
	["Distance"] = 30,
	["Coords"] = vec4(713.79,-960.02,30.4,204.1),
	["Model"] =  "s_f_y_airhostess_01",
	["Anim"] = { "anim@heists@heist_corona@single_team", "single_team_loop_boss" },
	["Collision"] = true
	},{ -- Bank Sul
	...
	["Distance"] = 100,
	["Coords"] = vec4(1173.38,-1498.86,34.85,0.0),
	["Model"] = "s_m_y_airworker",
	["Anim"] = { "anim@heists@heist_corona@single_team","single_team_loop_boss" },
	["Collision"] = true
},{ -- Garagem 1
["Distance"] = 100,
["Coords"] = vec4(-780.31,-2454.96,14.64,0.0),
["Model"] = "s_m_y_airworker",
["Anim"] = { "anim@heists@heist_corona@single_team","single_team_loop_boss" },
["Collision"] = true
},{ -- Garagem 
["Distance"] = 100,
["Coords"] = vec4(443.49,-974.47,25.7,195.0),
["Model"] = "s_m_y_airworker",
["Anim"] = { "anim@heists@heist_corona@single_team","single_team_loop_boss" },
["Collision"] = true
	},{ -- Garagem 9
	["Distance"] = 100,
	["Coords"] = vec4(1164.52,-1537.35,34.85,0.0),
	["Model"] = "s_m_y_airworker",
	["Anim"] = { "anim@heists@heist_corona@single_team","single_team_loop_boss" },
	["Collision"] = true
	},{ -- Garagem 2
	...
	["Distance"] = 15,
	["Coords"] = vec4(1146.72,107.56,81.44,249.45),
	["Model"] = "mp_m_shopkeep_01",
	["Anim"] = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},{ -- Departament Store
		["Distance"] = 15,
	...
	["Distance"] = 50,
	["Coords"] = vec4(231.95,211.53,105.45,102.05),
	["Model"] = "a_m_o_ktown_01",
	["Anim"] = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},{ -- Lenhador
	["Distance"] = 50,
	["Coords"] = vec4(2958.23,2752.65,43.71,170.08),
	["Model"] = "a_m_o_ktown_01",
	["Anim"] = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},{ -- Pescador
		["Distance"] = 30,
    ...
    ["Distance"] = 15,
    ["Coords"] = vec4(511.71, -1804.36, 28.51, 0.0),
    ["Model"] = "s_m_y_ammucity_01",
    ["Anim"] = { "anim@heists@heist_corona@single_team", "single_team_loop_boss" }
}, { -- Department Store
    ["Distance"] = 15,
    ["Coords"] = vec4(232.58, -1751.01, 29.0, 0.0),
    ["Model"] = "s_m_y_ammucity_01",
    ["Anim"] = { "anim@heists@heist_corona@single_team", "single_team_loop_boss" }
}, { -- Department Store
    ["Distance"] = 15,
    ["Coords"] = vec4(92.52, -1982.2, 20.44, 0.0),
    ["Model"] = "s_m_y_ammucity_01",
    ["Anim"] = { "anim@heists@heist_corona@single_team", "single_team_loop_boss" }
}, { -- Department Store
    ["Distance"] = 15,
    ["Coords"] = vec4(-28.47, -1429.34, 31.34, 0.0),
    ["Model"] = "s_m_y_ammucity_01",
    ["Anim"] = { "anim@heists@heist_corona@single_team", "single_team_loop_boss" }
}, { -- Department Store
    ["Distance"] = 15,
    ["Coords"] = vec4(348.06, -2069.76, 20.91, 0.0),
    ["Model"] = "s_m_y_ammucity_01",
    ["Anim"] = { "anim@heists@heist_corona@single_team", "single_team_loop_boss" }
}, { -- Department Store
    ["Distance"] = 15,
    ["Coords"] = vec4(510.48, -1815.38, 28.51, 0.0),
    ["Model"] = "s_m_y_ammucity_01",
    ["Anim"] = { "anim@heists@heist_corona@single_team", "single_team_loop_boss" }
}, { -- Department Store
    ["Distance"] = 15,
    ["Coords"] = vec4(341.53, -2064.0, 20.93, 0.0),
    ["Model"] = "s_m_y_ammucity_01",
    ["Anim"] = { "anim@heists@heist_corona@single_team", "single_team_loop_boss" }
}, { -- Department Store
    ["Distance"] = 15,
    ["Coords"] = vec4(3101.77, -1986.76, 20.69, 0.0),
    ["Model"] = "s_m_y_ammucity_01",
    ["Anim"] = { "anim@heists@heist_corona@single_team", "single_team_loop_boss" }
}, { -- Department Store
    ["Distance"] = 15,
    ["Coords"] = vec4(-33.42, -1430.98, 31.49, 0.0),
    ["Model"] = "s_m_y_ammucity_01",
    ["Anim"] = { "anim@heists@heist_corona@single_team", "single_team_loop_boss" }
}, { -- Department Store
    ["Distance"] = 15,
    ["Coords"] = vec4(236.04, -1762.16, 29.04, 0.0),
    ["Model"] = "s_m_y_ammucity_01",
    ["Anim"] = { "anim@heists@heist_corona@single_team", "single_team_loop_boss" }
}
