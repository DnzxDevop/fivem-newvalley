...
TicketItem = 'dirtydollar' -- Item necessário para iniciar a corrida
PaymentItem = 'dirtydollar' -- Item para pagamento
TrophyItem = 'racetrophy' -- Troféu ao consquistar o primeiro lugar
-----------------------------------------------------------------------------------------------------------------------------------------
-- ROUTES
-----------------------------------------------------------------------------------------------------------------------------------------
Routes = {
