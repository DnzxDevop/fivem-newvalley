...
function QuantumGG.GetCurrentCoords(source)
...
RegisterNetEvent("inventory:SetPlate")
AddEventHandler("inventory:SetPlate",function(Plate)
...
-- TYREHEALTH
-----------------------------------------------------------------------------------------------------------------------------------------
function QuantumGG.tyreHealth(Network,Tyre)
	if NetworkDoesNetworkIdExist(Network) then
		local Vehicle = NetToEnt(Network)
...
-- ENTIITYCOORDSZ
-----------------------------------------------------------------------------------------------------------------------------------------
function QuantumGG.EntityCoordsZ()
	local Ped = PlayerPedId()
	local Coords = GetEntityCoords(Ped)
