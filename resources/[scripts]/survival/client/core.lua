...
-----------------------------------------------------------------------------------------------------------------------------------------
QuantumGG = {}
Tunnel.bindInterface("survival",QuantumGG)
-----------------------------------------------------------------------------------------------------------------------------------------
-- VARIABLES
-----------------------------------------------------------------------------------------------------------------------------------------
...
function FinishSurvival()
	...
	SetTimeout(5000,function()
		...
		SetEntityCoords(Ped,-1037.07,-2738.04,20.17)
		DoScreenFadeIn(2500)
	end)
end
-----------------------------------------------------------------------------------------------------------------------------------------
...
-- REVIVE
-----------------------------------------------------------------------------------------------------------------------------------------
function QuantumGG.Revive(Health)
	exports["survival"]:Revive(Health)
end