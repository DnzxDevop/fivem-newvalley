...
AddEventHandler("admin:Dynamic", function(Mode)
	...
	if Passport then
		if Mode == "wl" then
			if vRP.HasGroup(Passport,"Admin",8) then
		...
		elseif Mode == "rename" then
			if vRP.HasGroup(Passport,"Admin",3) then
				...
				if Keyboard then
					...
					exports["discord"]:Embed("Admin","**Passaporte:** "..Passport.."\n**Comando:** rename "..Keyboard[1].." "..Keyboard[2].." "..Keyboard[3],0x800080)
				end
			else
				TriggerClientEvent("Notify",source,"Atenção","Você não tem permissões para isso.","amarelo",5000)
			end
			...
			if vRP.HasGroup(Passport,"Admin",3) then
				...
				if Keyboard then
					...
					if vRP.Request(Passport, "Inventário", "Você realmente deseja limpar o inventário de <b>"..FullName.."</b>?") then
						--exports["discord"]:Embed("Admin","**Passaporte:** "..Passport.."\n**Comando:** clearinv "..Keyboard[1],0x800080)
			...
			if vRP.HasGroup(Passport,"Admin",1) then
				...
				if Keyboard then
					...
					if Identity then
						...
						exports["discord"]:Embed("Admin","**Passaporte:** "..Passport.."\n**Comando:** gem "..Keyboard[1].." "..Keyboard[2],0x800080)
		...
		elseif Mode == "god" then
			if vRP.HasGroup(Passport,"Admin",7) then
				local Keyboard = vKEYBOARD.Primary(source,"Passaporte:")
				if Keyboard then
					exports["discord"]:Embed("Admin","**Passaporte:** "..Passport.."\n**Comando:** god "..Keyboard[1],0x800080)
		...
		elseif Mode == "armour" then
			if vRP.HasGroup(Passport,"Admin",1) then
				local Keyboard = vKEYBOARD.Primary(source,"Passaporte:")
				if Keyboard then
					exports["discord"]:Embed("Admin","**Passaporte:** "..Passport.."\n**Comando:** armour "..Keyboard[1],0x800080)
			...
			if vRP.HasGroup(Passport,"Admin",1) then
				...
				if Keyboard then
					if ItemIndex(Keyboard[1]) ~= nil then
						exports["discord"]:Embed("Admin","**Passaporte:** "..Passport.."\n**Comando:** item "..Keyboard[1].." "..Keyboard[2],0x800080)
			...
			if vRP.HasGroup(Passport,"Admin",1) then
				...
				if Keyboard then
					if ItemIndex(Keyboard[2]) ~= nil then
						exports["discord"]:Embed("Admin","**Passaporte:** "..Passport.."\n**Comando:** item2 "..Keyboard[1].." "..Keyboard[2].." "..Keyboard[3],0x800080)
		...
		elseif Mode == "itemall" then
			if vRP.HasGroup(Passport,"Admin",1) then
				...
				if Keyboard then
					if ItemIndex(Keyboard[1]) ~= nil then
						exports["discord"]:Embed("Admin","**Passaporte:** "..Passport.."\n**Comando:** itemall "..Keyboard[1].." "..Keyboard[2],0x800080)
		...
		elseif Mode == "delete" then
			if vRP.HasGroup(Passport,"Admin",1) then
				local Keyboard = vKEYBOARD.Primary(source,"Passaporte:")
				if Keyboard then
					exports["discord"]:Embed("Admin","**Passaporte:** "..Passport.."\n**Comando:** unban "..Keyboard[1],0x800080)
			...
			if vRP.HasGroup(Passport,"Admin",2) then
				...
				if Keyboard then
					...
					if ClosestPed then
						...
						exports["discord"]:Embed("Admin","**Passaporte:** "..Passport.."\n**Comando:** skin "..Keyboard[1].." "..Keyboard[2],0x800080)
				...
				if Keyboard then
					...
					if ClosestPed then
						...
						if Identity then
							...
							exports["discord"]:Embed("Admin","**Passaporte:** "..Passport.."\n**Comando:** resetskin "..Keyboard[1],0x800080)
		...
		elseif Mode == "nc" then
			if vRP.HasGroup(Passport,"Admin",8) then
				...
				exports["discord"]:Embed(
					"Admin",  -- Título do embed
					"O Passport" ..Passport.. "Utilizou o comando **NC**", -- Mensagem
					0x800080  -- Cor do embed (verde)
					 )
			else
				TriggerClientEvent("Notify",source,"Atenção","Você não tem permissões para isso.","amarelo",5000)
			end
			...
			if vRP.HasGroup(Passport,"Admin",4) then
				...
				if Keyboard then
					...
					if OtherSource then
						...
						exports["discord"]:Embed("Admin","**Passaporte:** "..Passport.."\n**Comando:** kick "..Keyboard[1],0x800080)
				...
				if Keyboard then
					...
					if Identity then
						...
						if OtherSource then
							...
							exports["discord"]:Embed("Admin","**Passaporte:** "..Passport.."\n**Comando:** ban "..Keyboard[1].." "..Keyboard[2],0x800080)
					...
					if tonumber(Level) then
						if vRP.GroupType(Permission) then
							if not vRP.GetUserType(OtherPassport, "Work") then
								exports["discord"]:Embed("Admin", "**Passaporte:** "..Passport.."\n**Comando:** group "..OtherPassport.." "..Permission.." "..Level, 0x800080)
		...
		elseif Mode == "ungroup" then
			if vRP.HasGroup(Passport,"Admin",3) then
				...
				if Keyboard then
					...
					exports["discord"]:Embed("Admin","**Passaporte:** "..Passport.."\n**Comando:** ungroup "..Keyboard[1].." "..Keyboard[2],0x800080)
		...
		elseif Mode == "announce" then
			if vRP.HasGroup(Passport,"Admin",3) then
				local Keyboard = vKEYBOARD.Tertiary(source,"Segundos:","Título:","Anúncio:")
				if Keyboard then
					TriggerClientEvent("Notify",-1,"Prefeitrua",Keyboard[1] * 1000,Keyboard[2],Keyboard[3])
				--	exports["discord"]:Embed("Admin","**Passaporte:** "..Passport.."\n**Comando:** announce "..Keyboard[1].." "..Keyboard[2].." "..Keyboard[3].." "..Keyboard[4] * 1000,0x800080)
				end
			else
				TriggerClientEvent("Notify",source,"Atenção","Você não tem permissões para isso.","amarelo",5000)
			end
		elseif Mode == "chatannounce" then
			if vRP.HasGroup(Passport,"Admin",3) then
				...
				if Keyboard then
					...
					exports["discord"]:Embed("Admin","**Passaporte:** "..Passport.."\n**Comando:** chatannounce "..Messages,0x800080)
				end
			else
				TriggerClientEvent("Notify",source,"Atenção","Você não tem permissões para isso.","amarelo",5000)
			end
			...
			if vRP.HasGroup(Passport,"Admin",2) then
				...
				if Keyboard and Keyboard[1] and Keyboard[2] and VehicleExist(Keyboard[2]) then
					...
					if Consult[1] then
						...
						exports["discord"]:Embed("Admin","**Passaporte:** "..Passport.."\n**Comando:** setcar "..Keyboard[1].." "..Keyboard[2],0x800080)
		...
		elseif Mode == "remcar" then
			if vRP.HasGroup(Passport,"Admin",2) then
				...
				if Keyboard then
					...
					exports["discord"]:Embed("Admin","**Passaporte:** "..Passport.."\n**Comando:** remcar "..Keyboard[1].." "..Keyboard[2],0x800080)
		...
		elseif Mode == "clearprison" then
			if vRP.HasGroup(Passport,"Admin",3) then
				...
				if Keyboard then
					...
					if OtherPlayer then
						exports["discord"]:Embed("Admin","**Passaporte:** "..Passport.."\n**Comando:** clearprison "..Keyboard[1],0x800080)
				...
				if Keyboard then
					...
					for k, v in pairs(UsersList) do
						...
						if OtherSource then
							exports["discord"]:Embed(
								"Admin",  -- Título do embed
								"O Passport" ..Passport.. "Utilizou o comando **CREATE LIGHT**", -- Mensagem
								0x800080  -- Cor do embed (verde)
								 )
		...
		elseif Mode == "commands" then
			if vRP.HasGroup(Passport,"Admin",1) then
				...
				if Keyboard then
					exports["discord"]:Embed(
							"Admin", 
							"O Passport " .. Keyboard[1] .. " Utilizou o comando **Commands**",
							0xa3c846 
						)
