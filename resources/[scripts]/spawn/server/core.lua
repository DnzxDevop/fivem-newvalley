...
function Hensa.NewCharacter(Name, Lastname, Sex)
	...
	if not Active[source] then
		...
		vRP.Query("characters/NewCharacter",{ License = License, Name = Name, Lastname = Lastname, Avatar = "https://host-two-ochre.vercel.app/files/valley_sem_fundo.png", Sex = Sexo,  Skin = Sex, Phone = vRP.GeneratePhone(), Blood = math.random(4) })
