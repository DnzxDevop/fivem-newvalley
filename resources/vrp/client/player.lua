...
AddEventHandler("vRP:Active", function(Passport, Name)
	SetDiscordAppId(1319062316863586315)
	SetDiscordRichPresenceAsset("valley_puro")
	SetRichPresence("#"..Passport.." "..Name)
	SetDiscordRichPresenceAssetSmall("valley_puro")
	SetDiscordRichPresenceAssetText("New Valley - Ato 1")
	SetDiscordRichPresenceAssetSmallText("Jogando no New Valley")
	SetDiscordRichPresenceAction(0, "New Valley", ServerLink)
	...
	AddTextEntry("FE_THDR_GTAO", "QuantumGG")
end)
-----------------------------------------------------------------------------------------------------------------------------------------
-- HEALTHRECHARGE
-----------------------------------------------------------------------------------------------------------------------------------------
