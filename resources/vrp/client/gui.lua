...
CreateThread(function()
	local QuantumGGBinds = GetResourceKvpString("QuantumGGBinds")
	Binded = (QuantumGGBinds and json.decode(QuantumGGBinds)) or {}
end)
-----------------------------------------------------------------------------------------------------------------------------------------
-- WALKERS
-----------------------------------------------------------------------------------------------------------------------------------------
...
function tvRP.CheckCuff(source)
...
RegisterCommand("binds",function(source,Message)
	if Message[1] and Message[2] and parseInt(Message[1]) >= 1 and parseInt(Message[1]) <= 9 then
		...
		SetResourceKvp("QuantumGGBinds",json.encode(Binded))
