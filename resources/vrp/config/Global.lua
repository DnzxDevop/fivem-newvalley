...
SalarySeconds = 3600 -- tempo do salário
...
ServerName = "New Valley" -- nome do servidor
...
ServerLink = "https://discord.gg/newvalleyrp" -- link de sua preferência
...
MaintenanceLicenses = { -- licenses que podem entrar no servidor durante a manutenção
	["9b0fa34ec61632aecf9bde778f209efd1479e929"] = true,
	["0c365461b035f66d6b9e6d3652ca173b202c49c4"] = true,
	["73831236e9b9d3e515160081cc1ad4c832be78db"] = true,
	["80b77ad22134f1925d4f1f16bb8d69922cafa4ad"] = true,
	["afadc4fca897ad0f660e158d8edb980d7118804c"] = true,
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- TEXTS
-----------------------------------------------------------------------------------------------------------------------------------------
BannedText = "Você foi banido, entre no discord para qualquer duvida." -- texto de banimento
ReleaseText = "Servidor Fechado." -- texto de liberação da whitelist
...
DefaultBackpackPremium = 50 -- peso padrão do inventário Premium
DefaultBackpackNormal = 45 -- peso padrão do inventário
-----------------------------------------------------------------------------------------------------------------------------------------
-- HUNGER / THIRST
-----------------------------------------------------------------------------------------------------------------------------------------
ConsumeHunger = 1 -- quantos % vai consumir da fome
ConsumeThirst = 1 -- quantos % vai consumir da sede
CooldownHungerThrist = 100000 -- tempo de desgaste
-----------------------------------------------------------------------------------------------------------------------------------------
-- THEME
-----------------------------------------------------------------------------------------------------------------------------------------
