...
vRP.Prepare("characters/NewCharacter","INSERT INTO characters(License,Name,Lastname,Avatar,Sex,Skin,Phone,Blood,Created) VALUES(@License,@Name,@Lastname,@Avatar,@Sex,@Skin,@Phone,@Blood,UNIX_TIMESTAMP() + 259200)")
-----------------------------------------------------------------------------------------------------------------------------------------
-- ACCOUNTS
-----------------------------------------------------------------------------------------------------------------------------------------
...
vRP.Prepare("fines/RemoveCharacters", "UPDATE characters SET Fines = Fines - @Price WHERE Passport = @Passport")
vRP.Prepare("fines/CharactersAdd", "UPDATE characters SET Fines = Fines + @Price WHERE Passport = @Passport")
...
-- CLEARTABLES
-----------------------------------------------------------------------------------------------------------------------------------------
vRP.Prepare("QuantumGG/Playerdata","DELETE FROM playerdata WHERE Information = '[]' OR Information = '{}'")
vRP.Prepare("QuantumGG/Entitydata","DELETE FROM entitydata WHERE Information = '[]' OR Information = '{}'")
vRP.Prepare("QuantumGG/Transactions","DELETE FROM transactions WHERE UNIX_TIMESTAMP() >= Timeset")
vRP.Prepare("QuantumGG/Premium","UPDATE accounts SET Premium = '0' WHERE UNIX_TIMESTAMP() >= Premium")
-----------------------------------------------------------------------------------------------------------------------------------------
-- THREADSTART
-----------------------------------------------------------------------------------------------------------------------------------------
CreateThread(function()
	vRP.Query("QuantumGG/Premium")
	vRP.Query("QuantumGG/Playerdata")
	vRP.Query("QuantumGG/Entitydata")
	vRP.Query("QuantumGG/Transactions")
end)