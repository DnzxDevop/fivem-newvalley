-- Locales
DX_AC.IsAdmin = false -- DON'T TOUCH THIS
...
-- MENU 2
local menu2 = MenuV:CreateMenu(false, "DX-AC Admin Tools", 'centerright', 255, 0, 0, 'size-125', 'example', 'menuv', 'DX-AC: Admin Menu')
...
-- MENU 3
local menu3 = MenuV:CreateMenu(false, "DX-AC: Connected Players", 'centerright', 255, 0, 0, 'size-125', 'example', 'menuv', 'DX-AC: Connected Players')
...
-- MENU 4
local menu4 = MenuV:CreateMenu(false, "DX-AC Server Tools", 'centerright', 255, 0, 0, 'size-125', 'example', 'menuv', 'DX-AC: Server Tools')
...
-- MENU 5
local menu5 = MenuV:CreateMenu(false, "DX-AC Teleport Options", 'centerright', 255, 0, 0, 'size-125', 'example', 'menuv', 'DX-AC: Teleport Options')
...
-- MENU 6
local menu6 = MenuV:CreateMenu(false, "DX-AC Vehicle Tools", 'centerright', 255, 0, 0, 'size-125', 'example', 'menuv', 'DX-AC: Vehicle Tools')
...
-- MENU 7
local menu7 = MenuV:CreateMenu(false, "DX-AC Admin Tools", 'centerright', 255, 0, 0, 'size-125', 'example', 'menuv', 'DX-AC: TP Tools Tools')
local menu7_acinfo = menu7:AddButton({ icon = 'ℹ️', label = 'AntiCheat Version: 4.0', description = 'discord.com/invite/EAU2DM4hdn' })
local menu7_creatorac = menu7:AddButton({ icon = 'ℹ️', label = 'DX-AC by Quantum', description = 'discord.com/invite/EAU2DM4hdn' })
...
-- PRINCIPAL MENU
local menu = MenuV:CreateMenu(false, "Welcome to DX-AC's Admin Menu", 'centerright', 255, 0, 0, 'size-125', 'example', 'menuv', 'DX-AC: Main Menu')
...
RegisterCommand('dxacmenu', function()
    if DX_AC.IsAdmin then
        menu:Open()
    end
end, false)

RegisterKeyMapping('dxacmenu', "DX-AC Admin Menu", 'keyboard', 'INSERT')
